...
console.log(name)
$.ajax({url:'https://api.airtable.com/v0/appYa571DMs4tRC4f/%E5%8D%9A%E5%AE%A2%E5%8F%8D%E9%A6%88',headers:{'Authorization':'Bearer keyCTQs10mYGYNALo'},type:'post',contentType:"application/json",success:function(data){console.log(data)},error:function(data){console.log(data)},data:JSON.stringify({records:[{fields:{"电子邮箱":email,"用户昵称":name,"疑问和建议":message}}]})});})})(jQuery);